...
const toggleItem = (id) => {
    ...
    const index = statusStore.getStatuses.findIndex(
        (status) => status.id === id
    )
...
<template>
    ...
    >
        ...
        <template #navigate-home>Home</template>
            ...
            >
                <div
                    class="container z-30 md-vertical:scale-95 mobile:scale-[87%]"
                >
                    <div
                        class="itbkk-status-filter select-btn"
                        :class="[
                            showList ? 'open' : '',
                            taskStore.filterStatuses.length >= 2
                                ? 'h-auto'
                                : 'h-[40px]'
                        ]"
                    ...
                    >
                        ...
                        >
                            Filter by
                            {{
                                statusStore.getStatuses.length > 1
                                    ? 'Statuses'
                                    : 'Status'
                            }}
                        </span>
                    ...
                    <div class="my-3 mr-2">
                        ...
                        >
                            <input
                                ...
                                @click.prevent="
                                    popup.boardVisibilityPopup = true
                                "
                                :disabled="!isOwner"
                            />
                            <span
                        ...
                        >
                            ...
                            <tbody class="bg-white">
                                ...
                                >
                                    ...
                                    >
                                        <div class="flex">
                                            <p class="hover:underline cursor-pointer hover:text-blue text-[16px]">{{ task.title }}</p>
